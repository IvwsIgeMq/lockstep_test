...
int lua_cocos2dx_physics_updateTransformFromPhysics(lua_State* tolua_S)
{
    int argc = 0;
    ...
    if (!cobj)
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_cocos2dx_physics_updateTransformFromPhysics'", NULL);
        return 0;
    }
#endif
    ...
    if(argc == 0 )
    {
        ...
        cobj->updateTransformFromPhysics(parentTransform, 1);
         return 0;
    }
#if COCOS2D_DEBUG >= 1
tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_physics_updateTransformFromPhysics'.",&tolua_err);
#endif
    
    return 0;
}

int lua_cocos2dx_physics_updatePhysicsBodyTransform(lua_State* tolua_S)
{
    int argc = 0;
    cocos2d::Node* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj)
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_cocos2dx_physics_updatePhysicsBodyTransform'", NULL);
        return 0;
    }
#endif
    ...
    if(argc == 0 )
    {
        if(!ok)
            return 0;
        auto& parentTransform =   Director::getInstance()->getMatrix(MATRIX_STACK_TYPE::MATRIX_STACK_MODELVIEW);
        cobj->updatePhysicsBodyTransform(parentTransform,  0, 1.0f, 1.0f);
        return 0;
    }
#if COCOS2D_DEBUG >= 1
tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_physics_updatePhysicsBodyTransform'.",&tolua_err);
#endif
...
int register_all_cocos2dx_physics_manual(lua_State* tolua_S)
{
    ...
    {
        lua_pushstring(tolua_S, "updateTransformFromPhysics");
        lua_pushcfunction(tolua_S, lua_cocos2dx_physics_updateTransformFromPhysics);
        lua_rawset(tolua_S,-3);
        lua_pushstring(tolua_S, "updatePhysicsBodyTransform");
        lua_pushcfunction(tolua_S, lua_cocos2dx_physics_updatePhysicsBodyTransform);
        lua_rawset(tolua_S,-3);
